...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Here you would typically handle form submission with a backend API
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-xl shadow-md h-full">
                ...
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex">
                    ...
                    <div>
                      ...
                      <a
                        href={info.link}
                        className="text-portfolio-neutral hover:text-portfolio-blue transition-colors"
                        target="_blank"
              ...
              <div className="mt-10">
                <h4 className="font-bold text-lg mb-4">Suivez-moi</h4>
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-portfolio-blue/10 hover:bg-portfolio-blue/20 rounded-full flex items-center justify-center transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg className="w-5 h-5 text-portfolio-blue" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-portfolio-blue focus:border-transparent"
