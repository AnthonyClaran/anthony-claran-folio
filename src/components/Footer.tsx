        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#home" className="text-2xl font-bold font-heading">
              <span className="text-portfolio-lightBlue">Anthony</span> Claran
            </a>
            <p className="mt-2 text-gray-400 max-w-md">
              Développeur Full Stack & Graphic Designer passionné par la création d'expériences digitales exceptionnelles.
            </p>
          </div>
